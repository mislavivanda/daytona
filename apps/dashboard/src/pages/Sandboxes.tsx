...
const Sandboxes: React.FC = () => {
  ...
  const openSshAccessConfig = (id: string) => {
    const sandboxToOpenSshAccessConfig = sandboxes.find((s) => s.id === id)
    if (sandboxToOpenSshAccessConfig) {
      setSelectedSandbox(sandboxToOpenSshAccessConfig)
  ...
  return (
    <div className="flex flex-col min-h-dvh px-10 py-3">
      ...
      <SandboxTable
        ...
        handleSshAccessConfig={openSshAccessConfig}
        data={sandboxes}
      ...
      <SandboxDetailsSheet
        ...
        loadingSandboxes={loadingSandboxes}
        setLoadingSandboxes={setLoadingSandboxes}
        handleStart={handleStart}
        handleStop={handleStop}
        handleDelete={(id) => {
          setSandboxToDelete(id)
